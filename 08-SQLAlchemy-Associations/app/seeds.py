...
# 2.a ✅ Add delete methods for Pet and Owner to clear the database before each seeding
    ...
    cat_breeds = ["Domestic Longhair", "Domestic Shorthair", "Siamese", "Tabby", "Burmese"]
   
    # Create a List of dog breeds

    dog_breeds = ["Terrier", "Chihuahua", "Husky", "Pug", "Shih-Tzu", "Poodle"]
 
    # Create a List of temperaments 

    temperaments = ["Relaxed", "Cool", "Playful", "Sleepy", "Cuddly", "Fiesty", "Grumpy"]
