...
if __name__ == '__main__':
    ...
    owners_pets = session.query(Owner).filter_by(id=first_owner.id)
    ...
    first_pet_owner = session.query(Owner).filter_by(id=first_pet.owner_id)

    # print([record for record in first_pet_owner])
